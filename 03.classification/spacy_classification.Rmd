...
data = pd.read_csv('../02.data/output_data/training_data_stem.csv')
data.head()
```
...
#### PREDICT DATA ####
#import new data
new_data = pd.read_csv("../02.data/output_data/test_data_new_stem.csv")
new_data.columns
...
#### PREDICT DATA ####
#import new data
new_data = pd.read_csv("../02.data/output_data/test_data_LRE_stem.csv")
new_data.columns
...
new_data.to_csv(r'spacy_predicted_LRE.csv')
```
