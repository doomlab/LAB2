...
```{r}
log_wv_skip_results <- cbind(py$log_wv_skip_results_0dev, py$log_wv_skip_results_1dev, 
                        "accuracy_dev" = py$log_wv_skip_accuracydev, 
                        py$log_wv_skip_results_0test, py$log_wv_skip_results_1test, 
...
colnames(log_wv_skip_results) <- c("precision0_dev","recall0_dev","f1_score0_dev",
                              ...
                              "precision1_testing","recall1_testing",
                              "f1_score1_testing","accuracy_testing")
write.csv(log_wv_skip_results, "log_wv_skip_results.csv")
```
