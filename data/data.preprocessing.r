...
small_data2$class <- ifelse(small_data2$class == 1, 0, 1)
...
small_data2$text <- gsub("-", " ", small_data2$text)
...
##write out one here
write.csv(small_data2, "data/output_data/new_data_cleaned_no_stem.csv")
